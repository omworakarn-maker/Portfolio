...
export function Shell({ children, home = false }: { children: React.ReactNode, home?: boolean }) {
    ...
    return <div className={home ? "site-shell home-shell" : "site-shell"}>
        ...
        {!home && <footer><div><b>Worakan Pongseelawat</b>Call me Ohm<span>Developer.</span></div><nav style={{ alignItems: 'flex-start' }}><a href="https://github.com/omworakarn-maker" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-block', alignSelf: 'flex-start' }}>GitHub ↗</a><Link href="/contact#contact-form" style={{ display: 'inline-block', alignSelf: 'flex-start' }}>Contact ↗</Link></nav><small>© 2026 · Worakan Pongseelawat</small></footer>}</div>
}
