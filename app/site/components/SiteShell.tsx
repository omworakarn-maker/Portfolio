...
export function Shell({ children, home = false }: { children: React.ReactNode, home?: boolean }) {
    ...
    return <div className={home ? "site-shell home-shell" : "site-shell"}>
        ...
        {!home && <footer><div><b>Worakan Pongseelawat</b>Call me Ohm<span>Developer.</span></div><nav style={{ alignItems: 'flex-start' }}><a className="footer-icon-link footer-github-link" href="https://github.com/omworakarn-maker" target="_blank" rel="noopener noreferrer"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M12 .7A11.5 11.5 0 0 0 8.36 23.1c.58.1.79-.25.79-.56v-2.23c-3.23.7-3.91-1.37-3.91-1.37-.53-1.34-1.29-1.7-1.29-1.7-1.05-.72.08-.71.08-.71 1.17.08 1.78 1.2 1.78 1.2 1.04 1.77 2.72 1.26 3.38.96.1-.75.4-1.26.74-1.55-2.58-.29-5.29-1.29-5.29-5.69 0-1.26.45-2.29 1.19-3.1-.12-.29-.52-1.47.11-3.06 0 0 .97-.31 3.16 1.18a10.9 10.9 0 0 1 5.76 0c2.19-1.49 3.15-1.18 3.15-1.18.63 1.59.23 2.77.11 3.06.74.81 1.19 1.84 1.19 3.1 0 4.42-2.72 5.39-5.31 5.68.42.36.79 1.07.79 2.16v3.25c0 .31.21.67.8.56A11.5 11.5 0 0 0 12 .7Z" /></svg><span className="footer-link-roll"><i>GitHub ↗</i><i aria-hidden="true">GitHub ↗</i></span></a><Link className="footer-icon-link footer-contact-link" href="/contact#contact-form"><svg aria-hidden="true" viewBox="0 0 24 24"><path d="M12 12.2a5.1 5.1 0 1 0 0-10.2 5.1 5.1 0 0 0 0 10.2Zm0 2.3c-5.4 0-9.3 2.8-9.3 6.1 0 .8.6 1.4 1.4 1.4h15.8c.8 0 1.4-.6 1.4-1.4 0-3.3-3.9-6.1-9.3-6.1Z" /></svg><span className="footer-link-roll"><i>Contact ↗</i><i aria-hidden="true">Contact ↗</i></span></Link></nav><small>© 2026 · ALL RIGHTS RESERVED · WORAKAN PONGSEELAWAT</small></footer>}</div>
}
