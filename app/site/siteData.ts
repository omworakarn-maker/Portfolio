export type PageKey="home"|"about"|"work"|"take-five"|"stories"|"partners"|"support";
export const nav=[
...
export const pages={
  ...
  partners:{index:"05",kicker:"GOOD COMPANY",title:"Meet the people building the brighter bits with us.",intro:"Long-term collaborators, thoughtful specialists and generous humans.",color:"green"},
