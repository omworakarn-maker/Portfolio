...
export const pages={
  ...
  "take-five":{index:"04",kicker:"MY PROCESS",title:"How an idea moves from question to working experience.",intro:"From early research and rough ideas to a tested, refined interface—each project grows through curiosity, feedback, and iteration.",color:"pink"},
  ...
  support:{index:"05",kicker:"CONTACT",title:"Have an idea? Let's make something useful together.",intro:"Based in Thailand and available for freelance projects, collaborations, and thoughtful digital experiments. The easiest way to reach me is through the contact form below.",color:"black"}
} as const;
